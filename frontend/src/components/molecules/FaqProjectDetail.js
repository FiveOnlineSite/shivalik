...
const accordionItems = [
  ...
  },
  {
    ...
    content: [
        'Yes a NRI can invest but he need to possess all the required documents as suggested by RBI guidelinesy',
    ]
  },
  {
    id: '28',
    ...
    content: [
        'What documents are required from an Estate Agent in order to sell a developer’s flat?',
    ]
  },
];

            ...
            <div className='row align-items-center'>
                ...
                <div className='col-lg-6'>
                    <div className={homestyles.aboutText}>
                        ...
                        <p className='pb-5'>It all began in the early 80s, when two socially conscious gentlemen, Ramakant R. Jadhav and Prakash V. Ajgaonkar, rose to meet the challenge of making housing affordable for the lower and the middle class population of Mumbai. </p>
